 ...
 */
final class Version20220409205801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE receiver ADD CONSTRAINT FK_3DB88C9664D218E FOREIGN KEY (location_id) REFERENCES location (id)');
